...
tmux send-keys -t nav_layout:0.0 'sleep 5 && cd ../PX4-Autopilot-PRISMA && PX4_SIM_CLOCK=1 HEADLESS=1 PX4_SYS_AUTOSTART=4002 PX4_GZ_MODEL=x500_depth PX4_GZ_MODEL_POSE="-9.5 -3.5 0.5" ./build/px4_sitl_default/bin/px4' C-m  # Spawn x500 depth
